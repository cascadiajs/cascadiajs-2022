...
module.exports = async function({ ticket, connections }) {
    let content = /*html*/`
        <div id=page>
            ...
            <iframe id="retool-app" height="400" scrolling="no" allow="camera" style="border:none" src="https://retoolin.tryretool.com/embedded/public/3997468d-a0cf-4d2f-b18e-055db698b133?auth_hash=${ encodeURIComponent(ticket.auth_hash) }"></iframe>
